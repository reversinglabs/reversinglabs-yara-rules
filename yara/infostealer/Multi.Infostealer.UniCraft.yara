rule Multi_Infostealer_UniCraft {
    meta:
        description = "Detects UniCraft Launcher spyware/infostealer behavior. This rule targets unpacked payloads (ASAR/JS) and will not trigger on compressed installers (NSIS/SquashFS/DMG) until they are extracted."
        author = "koder-cog"
        version = "1.0"
        ...
        threat_name = "Multi.Infostealer.UniCraft"
        severity = "Critical"
